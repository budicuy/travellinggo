            ...
            >
                    ...
                    <div className="flex w-full h-full justify-center items-center text-center">
                        <div>
                            ...
                            <div className="font-semibold text-[8px] lg:text-lg">
                                <p>🌍✈️ Selamat datang di TravellingGo! Temukan Petualangan Tak Terlupakan Anda! ✈️🌍</p>
                                <p>🚀 Temukan Pengalaman Wisata yang Tidak Terlupakan dengan TravelingGo! 🚀</p>
                                <p>🌈 Liburan Tanpa Batas di Ujung Jari Anda - Kunjungi TravellingGo Sekarang! 🌈</p>
                ...
                <SwiperSlide>
                    <div className="h-[100dvh] overflow-hidden">
                        <Image fill className="block object-cover object-center w-full h-full opacity-50 " src="/337.jpg" alt="" />
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="h-[100dvh] overflow-hidden">
